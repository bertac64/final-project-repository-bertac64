...
HD_PWD='/home/docker/repos/hdl/projects/mz7020_som_base_2023_2/mz7020_som_base.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mz7020_som_base_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mz7020_som_base_wrapper.tcl -notrace
