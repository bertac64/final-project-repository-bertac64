...
HD_PWD='/home/docker/repos/hdl/projects/mz7020_som_base_2023_2/mz7020_som_base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mz7020_som_base_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mz7020_som_base_wrapper.tcl
