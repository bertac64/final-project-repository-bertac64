...
for ($pass = 1;;$pass++) {
	...
	sendto("pars Hexagon $HV 100 1 $LV 10 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 41 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 02 06 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 48 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 10 30 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 42 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 04 0C \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 50 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 20 21 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 44 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 08 18 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 40 60 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 01 03 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 20 60 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 10 18 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 04 44 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 02 03 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 10 50 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 08 0C \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 02 42 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 01 21 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 08 48 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 04 06 \\\\") or log_ko("Problems with pars") and last;
	sendto("+ 4 100 $N_LV $L_LV 01 41 \\\\") or log_ko("Problems with pars") and last;
	sendtoA("+ 4 100 $N_LV $L_LV 20 30") or log_ko("Problems with pars") and last;

	waitfor("!CS armed wtreat", 10) or log_ko("Problems going in wtreat") and last;
	sleep 0.5;
	...
	$n = ($n+0)/$np;
	if ($n == 24) {
         log_out("At pass $pass, $n sequences completed");
	}
	else {
	     log_out("WARNING: at pass $pass, $n sequences completed (24 expected)");
	}
	
	waitfor("!CS trtmt done", 4) or log_ko("Problems with pulse") and last;
	#sleep 0.5;

	sendto("peek 8") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("Stato: $Found");

	sendto("peek 26") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("Stato2: $Found");
	
	sendto("peek 10") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("hope: $Found");
	
	sendto("peek 11") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("hopemx: $Found");
	
	sendto("peek 12") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("Carica: $Found");
	
	sendto("peek 13") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("hvctr: $Found");

	sendto("peek 78") or log_ko("Problems reading registers") and last;
	waitfor("\\+OK",5);
	log_out("dac: $Found");
...
#	sleep(0.5);
	...
	if ($Alarm) {
		...
		# Ricarica
#		print STDERR "\t+ Charging\n";
#		sendtoA("charge $HVC $LV") or log_ko("Problems with charge $HVC $LV") and last;
